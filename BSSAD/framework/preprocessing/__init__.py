...
def normalize_and_encode_signals(df_ori,signals,scaler=None):
    ...
    Parameters
    ----------
    df : the pandas DataFrame of the sensor dataset
    signals : the signals of interest in the dataset
    scaler : the scaler for normalization; 
    ...
    Returns
    ----------
    modified_df : the pandas DataFrame of the sensor dataset in which the signals have been normalized or onehot encoded 
    '''
    df = df_ori.copy()
    onehot_entries = {}
